...
public class TlvComponent {
     ...
     *
     * @param valueField
     *            the byte array of tlv value field
	...
	tlvLenBytes[0] = (byte) (((byte) lenBytes.length) | MULTI_BYTE_LENGTH_MASK);
	...
	int numBytes = (int) Math.ceil(s.length() / 2f);
     ...
     *
     * @param data
     *            the first byte of length field
     * @return the number of bytes that represent the length field <br>
     *         <b>example:</b>
     *         <table>
     *         <tr align = center>
     *         <th>data</th>
     ...
     *         <td>0x82</td>
     *         <td>3</td>
     *         <td>the length filed is reprenested by 3 bytes</td>
     *         </tr>
     *         <tr align = center>
     *         <td>0x65</td>
     *         <td>1</td>
     *         <td>the length filed is reprenested by 1 bytes</td>
     *         </tr>
     *         </table>
     */
	...
	if ((data & MULTI_BYTE_LENGTH_MASK) == MULTI_BYTE_LENGTH_MASK) {
	    size += data & SINGLE_BYTE_LENGTH_MASK;
	}
	return size;
    }
     ...
     *
     * @param data
     *            byte array with a sequence of tlv data objects
     * @param offset
     *            the offset of byte array
     * @return the length of value field
     */
    public int getLength(byte[] data, int offset) {
	int len = data[offset] & SINGLE_BYTE_LENGTH_MASK;
...
//
// private void addChildren(int aLevel, byte[] aBuf, int aOffset, String
// levelPadding, int aTagBytesCount, int aDataBytesCount, int valueLength,
...
// , levelPadding, aLevel, result.tlv.getTag(), result.offset, startPosition,
// aDataBytesCount, valueLength);
// }
// }
// }
